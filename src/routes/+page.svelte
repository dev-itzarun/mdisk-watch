...
<section>
	{#if data.obj.filename}
		...
		<video id="my-player" class="video-js vjs-16-9 rcorners1" controls preload="auto">
			<p class="vjs-no-js">
		...
		<div class="pt-3 pb-5">
			<a
				...
				href="intent:{data.obj
					.source}#Intent;action=com.mxtech.videoplayer.ad.playback_local;category=android.intent.category.DEFAULT;category=android.intent.category.BROWSABLE;package=com.mxtech.videoplayer.ad;b.decode_mode=2;S.mx_stream_url={data.obj.source};S.title={data.obj.filename};end"
			>
				Play with Mxplayer
			</a>
		</div>
		<div class="pb-3">
			<a
				class="btn btn-light"
				href="intent:{data.obj
					.download}#Intent;action=com.mxtech.videoplayer.ad.download;category=android.intent.category.DEFAULT;category=android.intent.category.BROWSABLE;package=com.mxtech.videoplayer.ad;b.decode_mode=2;S.title={data.obj.filename};end"
			>
